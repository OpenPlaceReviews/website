<template>
  <div class="expand-block">
      <div class="mission_container">
        ...
        <div v-show-slide="featuresOpen" class="missing_hidden">
          <p>
        ...
        <div @click="toggleFeatures" class="collapsed_btn">{{ featuresOpen ? 'Collapse' : 'Read more' }}</div>
      </div>
    </div>
